...
createBook = (data) => {
    ...
    ws.cell(1, 6).string('DIFF BETWEEN BAL AS PER BILL AND BAL@')
    ws.cell(1, 7).string('Occupier (Owner/Tenant')
    ws.cell(1, 8).string('Owner Name Correct')
    ws.cell(1, 9).string('Please specify correct owner name')
    ws.cell(1, 10).string('Owner\'s tel no')
    ws.cell(1, 11).string('Tenant\'s Name')
    ws.cell(1, 12).string('Tenant\s tel no')
    ws.cell(1, 13).string('Occupier Nationality')
    ws.cell(1, 14).string('Property Usage')
    ws.cell(1, 15).string('Property Type')
    ws.cell(1, 16).string('Name of shop/company if Non-Domestic')
    ws.cell(1, 17).string('Nature of business if Non-Domestic')
    ws.cell(1, 18).string('DR Code')
    ws.cell(1, 19).string('Black Area')
    ws.cell(1, 20).string('High Rise')
    ws.cell(1, 21).string('Reason Refuse To Pay')
    ws.cell(1, 22).string('Staff')
    ws.cell(1, 23).string('Photo')
